...
namespace ISoftViewerQCSystem.Services
{
    ...
    public class DbServiceHelper<T>
    {
        ...
        {
            { "DicomNodeDb", new TableMappingData() { TableName = "DicomNodes", PrimaryKey = "Name" } },
            { "DicomProviderDb", new TableMappingData() { TableName = "DicomServiceProvider", PrimaryKey = "Name" } },
            { "DicomDestinationNode", new TableMappingData() { TableName = "DicomDestinationNodes", PrimaryKey = "LogicalName" } },
            { "PacsConfig", new TableMappingData() { TableName = "SystemConfiguration", PrimaryKey = "Name" } },
            { "FileStorageDevice", new TableMappingData() { TableName = "StorageDevice", PrimaryKey = "StorageDeviceID" } },
            { "DicomTags", new TableMappingData() { TableName = "DicomTags", PrimaryKey = "IdentifyName" } },
            { "DicomTagFilterDetail", new TableMappingData() { TableName = "DicomTagFilterDetail", PrimaryKey = "TagFilterName" } },
            { "DicomTagFilters", new TableMappingData() { TableName = "DicomTagFilters", PrimaryKey = "TagFilterName" } },
